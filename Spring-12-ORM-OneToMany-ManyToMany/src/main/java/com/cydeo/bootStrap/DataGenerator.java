...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(PaymentRepository paymentRepository, CustomerRepository customerRepository, MerchantRepository merchantRepository, CartRepository cartRepository, ItemRepository itemRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1= new Customer("Msmith","Mike", "Smith","m@cydoe","USA");
        payment1.setCustomer(customer1);
        payment2.setCustomer(customer1);
        customerRepository.save(customer1);


        Item item1 = new Item("Milk", "M!");
        Item item2 = new Item("Milk", "M!");
        Item item3 = new Item("Milk", "M!");
        Item item4 = new Item("Milk", "M!");
